## Configure backend (rail) links to stripe2 leaf switches (e1-4 side)
for i in 1 2 3 4 5 6 7 8; do
  ...
  ip -6 addr add fd00:200:$leaf:1:0:4:0:2/96 dev eth$i.100
  ...
  table=$((100 + i))
  src_ip="fd00:200:$leaf:1:0:4:0:2"
  gw=""
...
ip addr add 172.16.10.4/24 dev bond0.100
