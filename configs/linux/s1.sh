## Configure backend (rail) links to stripe1 leaf switches (e1-3 side)
for i in 1 2 3 4 5 6 7 8; do
  ...
  ip -6 addr add fd00:100:$i:1:0:3:0:2/96 dev eth$i.100
...
ip addr add 172.16.10.1/24 dev bond0.100
